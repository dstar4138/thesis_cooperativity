...
naive work-stealing approach via the single primary LPU. The queue length's
...
didn't match a process until much later. Despite this, it looks as though there 
...
Parallel Fibonacci, to properly test it. This is due to none of our test 
...
runtime quality of the application. Blocking channels, on the other hand, leak
hints to the scheduler which it may use to predict the future.
