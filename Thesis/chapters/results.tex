...
\begin{table}[!p]
    \begin{tabular}{@{}ccc}
        $Interactivity_{(16,8)}$ & \textbf{Absorption}       & \textbf{Blocking}       \\ \cline{2-3} 
\multicolumn{1}{c|}{\rotatebox{90}{\textbf{Communication Density}}} & 
...
This difference is also apparent in the number of avaliable processes each scheduler has
access to. The lengths of the process queues, fluxuate frequently in both
