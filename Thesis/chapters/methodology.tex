...
Also, note that the semantics of \emph{swap} is to block until a successful swap. 
...
\begin{itemize}
    \item {\bf The Multi-Threaded Round-Robin Global-Queue Scheduler {\sl (MTRRGQ)}} \\
        ...
        reductions per process before enqueuing and poping the top one).
        \begin{itemize}
            \item {\bf The Single-Threaded Round-Robin Scheduler {\sl (STRR)}} \\
                This scheduler is a special case where $P=1$. This will be our
                simplest scheduler test case, and will be compared against 
                {\sl STDQ}.
        \end{itemize}  
    ...
    \item {\bf The Multi-Threaded Round-Robin Work-Stealing Scheduler {\sl (MTRRWS)}} \\
        ...
        \begin{itemize}
            \item {\bf Shared-Queue {\sl (MTRRWS-SQ)}} \\
                ...
                a dequeue for a very short window of time, and involves 
                synchronizing on another LPUs queue.
            \item {\bf Interrupting-Steal {\sl (MTRRWS-IS)}} \\
                ...
                synchronizing on another LPUs process queue. 
        \end{itemize}
\end{itemize}
