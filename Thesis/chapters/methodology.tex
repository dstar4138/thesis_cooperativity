...
\subfigure[t][Process Blocking Swap]{
    \includegraphics[scale=0.4]{BlockingSwap.pdf}
    \label{fig:blockchan-example}
}
\subfigure[b][Process Absorption Swap]{
    \includegraphics[scale=0.4]{AbsorbSwap.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.8]{BipartiteGraph.pdf}
