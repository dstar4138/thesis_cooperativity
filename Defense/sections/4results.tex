...
\begin{slide}
    ...
    \inote{
        \item Remind about the goals of the talk. However there are other things
            we can of course study now that we have a simulator:
        \item LBB: Can also look at how the batch size effects different types
            of behaviours.
        \item CP: Could also look at a stealing mechanism.
    }
\end{slide}
...
\begin{table}
    ...
    \multicolumn{1}{c|}{$R=30$} &  \multicolumn{1}{c}{\includegraphics[scale=0.1]{tests/ptree/wssq/ca30r/pg_0003.pdf}} &
                                   \multicolumn{1}{c|}{\includegraphics[scale=0.1]{tests/ptree/wssq/ca30r/pg_0004.pdf}} &
                                   \multicolumn{1}{c}{\includegraphics[scale=0.1]{tests/ptree/lbb/ca30r/pg_0003.pdf}} &
                                   \multicolumn{1}{c|}{\includegraphics[scale=0.1]{tests/ptree/lbb/ca30r/pg_0004.pdf}} \\ \cline{1-5}
    ...
    \multicolumn{1}{c|}{$R=50$} &  \multicolumn{1}{c}{\includegraphics[scale=0.1]{tests/ptree/wssq/ca50r/pg_0003.pdf}} &
                                   \multicolumn{1}{c|}{\includegraphics[scale=0.1]{tests/ptree/wssq/ca50r/pg_0004.pdf}} &
                                   \multicolumn{1}{c}{\includegraphics[scale=0.1]{tests/ptree/lbb/ca50r/pg_0003.pdf}} &
                                   \multicolumn{1}{c|}{\includegraphics[scale=0.1]{tests/ptree/lbb/ca50r/pg_0004.pdf}} \\ \cline{1-5}
    \end{tabular}
\end{table}
}
    \inote{
